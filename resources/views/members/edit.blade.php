            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="card-title"><strong>Edit member: </strong>Name Goes Here</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" required name="name" placeholder="Member Name">
                                        </div>
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="hus_father" required name="hus_father" placeholder="Father/Husband">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="mother" required name="mother" placeholder="Mothers Name">
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="birthday" required name="birthday" placeholder="Date of Birth">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="nid" name="nid" placeholder="National ID">
                                        </div>
                                        @if ($errors->has('nid'))
                                            <span class="help-block ml-2 text-danger">
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" required id="nationality" placeholder="Nationality">
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="religion" required id="religion" placeholder="Present Address"></textarea>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control" name="permanent_address" id="permanent_address" placeholder="Permanent address"></textarea>
                                        </div>
