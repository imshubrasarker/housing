...
@section('content')
    <div id="page-wrapper">
        <div class="main-page">
            <a href="{{ route('admin.expenses-head.index') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
            <br>
            <br>
                        ...
                        <table class="table table-responsive">
                            ...
                            @foreach($head->expenses as $expense)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.expenses.show', $expense->id) }}">{{ $expense->title }}</a>
                                    </td>
