        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('admin.users.update') }}" method="post">
                            @csrf
                            @method('patch')
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $user->name }}" class="form-control" id="name" required name="name" placeholder="User Name">
                                        </div>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" value="{{ $user->email }}" id="email" required name="email" placeholder="johon@doe.com">
                                        </div>
                                        @if ($errors->has('email'))
                                            <span class="help-block ml-2 text-danger">
