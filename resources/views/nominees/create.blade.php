            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="card-title">Add new nominee</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('admin.nominees.store') }}" method="post">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="address" required id="address" placeholder="Address">{{ old('address') }}</textarea>
                                        </div>
